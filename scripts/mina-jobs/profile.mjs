...
const ROLE_PATTERNS = [
  {
    ...
    patterns: [
      ...
      /\b(?:senior )?business partner(?:,)? (?:hr|human resources)\b/,
  ...
  },
  {
    ...
    patterns: [
      ...
      /\bhead of people\b/,
      /\b(?:senior )?(?:manager|lead)(?: of)? talent operations\b/,
      /\btalent operations (?:manager|lead)\b/,
      /\b(?:senior )?(?:manager|lead)(?: of)? (?:employee experience|workforce planning|hr transformation|human resources transformation|hr programs?)\b/,
      /\b(?:employee experience|workforce planning|hr transformation|human resources transformation|hr programs?) (?:manager|lead)\b/,
      /\b(?:gestionnaire|responsable|chef|directeur|directrice)(?: de la| des)? (?:culture|operations) (?:et|des) (?:personnes|talents)\b/,
      /\b(?:gestionnaire|responsable|chef)(?: de l| des| du)? experience employe\b/,
      /\b(?:gestionnaire|responsable|chef)(?: de la)? planification des effectifs\b/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /\b(?:senior |principal )?(?:talent acquisition|recruiting|recruitment) (?:partner|advisor|adviser|consultant)\b/,
      /\bta manager\b/,
      /\b(?:senior |principal )(?:corporate )?recruiter\b/,
      /\b(?:senior |principal )?recruiting partner\b/,
      /\b(?:gestionnaire|responsable|chef|directeur|directrice)(?: de l)? acquisition de talents\b/,
      /\b(?:partenaire|conseiller|conseillere)(?: principal| principale)?(?: en)? acquisition de talents\b/,
      /\b(?:recruteur|recruteuse)(?: principal| principale| senior)\b/,
