...
const files = [
  { name: "Appointments_Report_20260722.csv", text: "Type,Client,Date,Session,State,Booking Info,Notes,Chart Status\nOne-On-One,Secret Patient,July 2 2026 - 10:00am,VIRTUAL 50-minute Individual Counselling Session with Gabriella Evans,Arrived,Booked on July 1 2026,,Signed\n" },
  ...
  { name: "Payments_Refunds_and_Fees_20260722.csv", text: "Date,Payer,Payment Method,Reference Number,Applied To,Amount,Processing Fees,Amount Paid to Clinic\nJuly 1 2026,Secret Patient,Visa,1,Invoice 1,100,-3,97\nJuly 22 2026,Secret Patient,Visa,2,Invoice 2,0,0,0\n" },
