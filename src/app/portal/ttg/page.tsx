  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16 lg:py-24">
      ...
      <div className="grid md:grid-cols-3 gap-5">
        ...
        <Link href="/portal/ttg/refresh" className="group block p-7 md:p-9 border border-[#d8ded9] rounded-[10px] bg-white hover:border-[#2f6f6d] hover:shadow-[0_12px_32px_rgba(32,48,47,0.08)] transition-all">
          <div className="text-xs uppercase tracking-[0.18em] text-[#2f6f6d] mb-12">Weekly close</div>
          <div className="flex items-end justify-between gap-6"><div><h2 className="font-display text-3xl mb-2">Refresh data</h2><p className="text-cream-muted text-sm max-w-sm">Upload the Jane and bank CSVs, review the checks, and publish the new reporting period.</p></div><span className="text-2xl text-[#2f6f6d] group-hover:translate-x-1 transition-transform">→</span></div>
        </Link>
